...
function getAppConfig(app){
    ...
    app.encryptAppKey = SHA1(app.appId+"UZ"+appKey+"UZ"+now)+"."+now;//加密后的key
}

/*********************
以下是第三方提供的JS-SDK，稍微改动了
*********************/
'use strict';
function copy(obj) {
...
function Resource(baseurl) {
    ...
    //如果url默认为APICloud的数据云域名的话
    if(this.baseurl == "https://d.apicloud.com/mcm/api")
    {
        var app = {appId:'',encryptAppKey:''};
        getAppConfig(app);
        this.appId = app.appId;
        this.appCode = app.encryptAppKey;
        this.defaultactions = {

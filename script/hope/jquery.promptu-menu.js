...
function setTimeHtml(date_, type) {
	...
	if (nowDate[0] == date_) {
		if (type == 'halfHour') {
			...
			//////////////原来代码////var nowH = parseInt(nowTime[0]) + 3;////指的是预约的时间必须是当前时间3小时之后
			var nowH = parseInt(nowTime[0]);
			...
			for (var i = 0; i < halfHourArray.length; i++) {
				if (i < getArrayKey(gethalfHourArray(), h + ':00')) {
					returnHtml += '<div class="time-table disabled">' +
						'<div>' + halfHourArray[i] + '<span class="font11">时间已过</span></div>' +
						'</div>';
				} else {
					returnHtml += "<div class='time-table' >" +
						"<div>" + halfHourArray[i] + "</div>" +
						"</div>";
					// if (/type=(\d+)/.exec(window.location.search)[1] == '33') { //日间照护
					// 	if (i >= 0 && i <= 4) {
					// 		returnHtml += "<div class='time-table' >" +
					// 			"<div>" + halfHourArray[i] + "</div>" +
					// 			"</div>";
					...
					// 			"</div>";
					// 	}
					// } else if (/type=(\d+)/.exec(window.location.search)[1] == '34') { //夜间照护
					// 	if (i >= 10 && i <= 12) {
					// 		returnHtml += "<div class='time-table' >" +
					// 			"<div>" + halfHourArray[i] + "</div>" +
					// 			"</div>";
					...
					// 			"</div>";
					// 	}
					// } else if (/type=(\d+)/.exec(window.location.search)[1] == '20') { //周期护
					// 	if (i >= 0 && i <= 10) {
					// 		returnHtml += "<div class='time-table' >" +
					// 			"<div>" + halfHourArray[i] + "</div>" +
					// 			"</div>";
